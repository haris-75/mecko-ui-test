...
class S3Sink extends Component {
    constructor(props) {
        super(props);
        this.state = {
            initialValues: {
                name: this.props.attributes.name || "s3_sink",
                ...
                {({
                    ...
                    <Form>
                        ...
                        {errors.access_key && touched.access_key ? (
                            <div className="invalid-feedback d-block">{errors.access_key}</div>
                        ) : null}


                        <Label className="form-group has-float-label mb-4">
                            Secret Key
                            <Field className="form-control" type="password" name="secret_key" />
                        </Label>
                        {errors.secret_key && touched.secret_key ? (
                            <div className="invalid-feedback d-block">{errors.secret_key}</div>
                        ) : null}
