...
module.exports = {
  /* 01.General */
  "general.copyright": "Mecku © 2019 All Rights Reserved.",

  /* 02.User Login, Logout, Register */
  "user.login-title": "Login",
  "user.loginpage.heading": "Welcome to Mecku",
  "user.register": "Register",
  "user.registerpage.heading": "Mecku awaits you!",
  "user.forgot-password": "Forgot Password",
  "user.reset-password": "Reset Password",
  "user.email": "E-mail",
  "user.password": "Password",
  "user.new-password": "New Password",
  "user.forgot-password-question": "Forgot your password?",
  ...
  "user.api-called": "...",
  "user.key": "Masking Key",

  /* Stages */
  "stage.name": "Name",
  "stage.host": "Host",
  "stage.port": "Port",
  "stage.user_name": "Username",
  "stage.password": "Password",
  "stage.compression_codec": "Compression Codec",
  "stage.comments": "Comments",
  "stage.separator": "Add Delimeter",
  "stage.file_format": "File format",

  "stage.hdfs.path": "Path",

  "stage.rdbms.database_name": "Database Name",
  "stage.rbms.table_name": "Table Name",
  "stage.rdbms.domain": "Domain",

  "stage.s3.access_key": "Access Key",
  "stage.s3.secret_key": "Secret Key",
  "stage.s3.bucket": "Bucket",
  "stage.s3.path": "Path",

  "stage.trans.values": "Values",
  "stage.trans.column_name": "Column Name",
  "stage.trans.sort_order": "Sort Order",

  "stage.trans.split.expression": "Expression",
  "stage.trans.split.num_of_splits": "Num of splits",
  "stage.trans.split.splitter": "Splitter",

  "stage.trans.union.column1": "Source Column 1",
  "stage.trans.union.column2": "Source Column 2",

  "stage.trans.merge.resultant_column_name": "Resultant Column Name",
  ...
  "menu.jobs": "Jobs",
  "menu.all": "All",
  "menu.allJobs": "All Jobs",
  "menu.default": "Default",
  "menu.analytics": "Analytics",
  "menu.ecommerce": "Ecommerce",
  "menu.content": "Content",
  "menu.workspaces": "Catalogs",
  "menu.catalogs": "Catalogs",
  "menu.allCatalogs": "All Catalogs",
  "menu.create-catalog": "New Catalog",
  "menu.data-list": "All Catalogs",
  "menu.allWorkspaces": "All Catalogs",
  "menu.create-workspace": "New Catalog",
  "menu.thumb-list": "ThumbList",
  "menu.image-list": "Top 10 Results",
  ...
  "dashboards.pii-doughnut": "Total PII Identified",
  ...
  "dashboards.logs": "User Activity",
  "dashboards.gogo": "Mecku",
  "dashboards.magic-is-in-the-details": "Metadata Summary",
  "dashboards.yes-it-is-indeed": "Data Sanitizer for the cloud!",
  ...
  "dashboards.pii-breakdown": "PII Breakdown",

  // Catalogs
  "catalogs.catalog-stats": "Catalog Statistics",
  ...
  "pages.support-info":
    "In case of any query, you can easily reach out to the Team. We give utmost priority to every single request or comment. We can answer any questions related to product and also cater to custom feature requests. Your feedback is very important for us.",
  ...
  // CloudGov Custom Buttons
  "button.workspace.create": "Create Workspace",
  ...
  "charts.pii-pie": "Total PII Identified",
  ...
  // CloudGov custom form entries.
  "forms.workspace.name": "Workspace Name",
  "forms.catalog.name": "Catalog Name",
  ...
  "sink.snowflake.username": "Snowflake Username",
  "sink.snowflake.password": "Snowflake Password",
  "sink.snowflake.warehouse_name": "Warehouse Name",
  "sink.snowflake.db_name": "Database Name",
  "sink.snowflake.url": "Url"
};
